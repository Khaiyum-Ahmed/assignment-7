...
const Banner = () => {
    return (
        <div className="max-w-11/12 mx-auto mb-20">
            <div className='text-center py-16 rounded-3xl bg-[#131313] relative'>
                <img className='absolute w-full h-full top-0 left-0 rounded-3xl' src={shadow} alt="" />
                ...
                <button className='font-bold text-base text-[#131313] py-3 px-5 bg-[#E7FE29] rounded-xl'>Claim Free Credit</button>
            </div>
        </div>
    );
};
